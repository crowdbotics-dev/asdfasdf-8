"""
Django settings for asdfasdf_8 project.
...
WSGI_APPLICATION = 'asdfasdf_8.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "asdfasdf_8 API",
    "DESCRIPTION": "API documentation for asdfasdf_8 App",
    "VERSION": "v1",
}
